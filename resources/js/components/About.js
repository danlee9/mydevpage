                    ...
                    <div className="ui grid">
                        <div className="row">
                            <div className="thirteen wide column">
                                <p>I'm a graduate of The University of Chicago who thought he was heading towards the world of finance, but ended up falling into the world of web development instead. I feel incredibly fortunate to have gone on this detour as I now can't imagine doing anything else. I really enjoy solving the different problems that come from programming and the puzzle-like challenges they present. When not staring at my text editor, I'm usually catching up on current events (news/podcast junkie), or watching a game, usually basketball, since I'm a huge sports fan (love all my LA teams). I also have a broad interest in a wide variety of things such as movies, music, pop culture, politics, psychology, economics, etc. Just an avid learner and curious about the world in general. I like having my brain feel stimulated! For more info check out the links to the side or go to my <Link to="/projects">projects</Link> page.</p>
                            </div>
